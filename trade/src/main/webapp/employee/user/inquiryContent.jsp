          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col">
                  <h2 class="h5 page-title"><small class="text-muted text-uppercase">문의</small><br>${idto.bno}</h2>
                </div>
                <div class="col-auto">
                  <button type="button" class="btn btn-secondary" onclick="location.href='./InquiryList.emp'">리스트로</button>
                </div>
              </div> <!-- .row -->
              <div class="row my-4">
                <div class="col-md-12">
                  <div class="card shadow mb-4">
                    <div class="card-header">
                      <strong class="card-title">${idto.subject}</strong>
                      <span class="float-right"><span class="badge badge-pill badge-success text-white">${idto.category}</span></span>
                    </div>
                    <div class="card-body">
                      <dl class="row align-items-center mb-0">
                        ...
                        <c:if test="${!idto.complete}">
                          <span class="dot dot-md bg-warning mr-2"></span> 미완료
                        </c:if>
                        </dd>
                      </dl>
                      <c:if test="${idto.complete}">
                    ...
                    <div class="card-body">
                      <div class="row align-items-center mb-4">
                        <div class="col-auto">
                          <div class="avatar avatar-sm mb-3 mx-4">
                          	...
                          	<c:if test="${udto.profile != ''}">
                          		<img src="<%=request.getRealPath("upload") %>/${udto.profile}" alt="..." class="avatar-img rounded-circle">
                          	</c:if>
                          </div>
                        </div>
                        <div class="col">
                          ...
                          <div class="card mb-3 bg-light w-50">
                            <div class="row no-gutters align-items-center">
                              <div class="col-md-2 text-center">
                                <img src="<%=request.getRealPath("upload") %>/${idto.image}" alt="..." class="img-fluid rounded m-1">
                              </div>
                              <div class="col-md-10">
                      ...
                      <form action="./InquiryAction.emp?bno=${idto.bno}" method="post">
                        <div class="form-group">
                          ...
                          <textarea class="form-control bg-light" name="answerContent" id="answerContent" rows="2"></textarea>
                        </div>
