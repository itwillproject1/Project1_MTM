              ...
              <div class="row mb-4 items-align-center">
                <div class="col-md">
                  ...
                  <c:if test="${pageCategory == 'all'}">
                    ...
                    <li class="nav-item">
                      <a class="nav-link text-muted px-2" href="<%=menulink%>&pageCategory=agree&pageNum=1">수신 동의 <span class="badge badge-pill bg-white border text-muted ml-2">${count[1]}</span></a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link text-muted px-2" href="<%=menulink%>&pageCategory=notAgree&pageNum=1">비동의 <span class="badge badge-pill bg-white border text-muted ml-2">${count[2]}</span></a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link text-muted px-2" href="<%=menulink%>&pageCategory=suspended&pageNum=1">정지된 회원 <span class="badge badge-pill bg-white border text-muted ml-2">${count[3]}</span></a>
                    </li>
                  </c:if>
                  <c:if test="${pageCategory == 'agree'}">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active bg-transparent pr-2 pl-0 text-primary" href="<%=menulink%>&pageCategory=agree&pageNum=1">수신동의 <span class="badge badge-pill bg-primary text-white ml-2">${count[1]}</span></a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link text-muted px-2" href="<%=menulink%>&pageCategory=notAgree&pageNum=1">비동의 <span class="badge badge-pill bg-white border text-muted ml-2">${count[2]}</span></a>
                    </li>
                  ...
                  <c:if test="${pageCategory == 'notAgree'}">
                    ...
                    <li class="nav-item">
                      <a class="nav-link text-muted px-2" href="<%=menulink%>&pageCategory=agree&pageNum=1">수신동의 <span class="badge badge-pill bg-white border text-muted ml-2">${count[1]}</span></a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active bg-transparent pr-2 pl-0 text-primary" href="<%=menulink%>&pageCategory=notAgree&pageNum=1">비동의 <span class="badge badge-pill bg-primary text-white ml-2">${count[2]}</span></a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link text-muted px-2" href="<%=menulink%>&pageCategory=suspended&pageNum=1">정지된 회원 <span class="badge badge-pill bg-white border text-muted ml-2">${count[3]}</span></a>
                    </li>
                  ...
                  <c:if test="${pageCategory == 'suspended'}">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active bg-transparent pr-2 pl-0 text-primary" href="<%=menulink%>&pageCategory=suspended&pageNum=1">정지된 회원 <span class="badge badge-pill bg-primary text-white ml-2">${count[3]}</span></a>
                    </li>
                  </c:if>
                  </ul>
                </div>
              ...
              <table class="table border table-hover bg-white">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                    	<p class="mb-0 text-muted"><strong>${i.user_name}</strong></p>
                    	<small class="mb-0 text-muted">${i.user_nickname}</small>
                    </td>
                    <td>${i.address}</td>
                    <td>${i.phone}</td>
                    <td>${i.email}</td>
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" style="">
                          <a class="dropdown-item" href="./UserInfo.emp?bno=${i.user_id}&pageNum=${pageNum}">상세보기</a>
