              ...
              <div class="row mb-4 items-align-center">
                <div class="col-md">
                  ...
                  <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <a class="nav-link text-muted px-2" href="./TradeList.emp?pageCategory=complete">완료 <span class="badge badge-pill bg-white border text-muted ml-2">48</span></a>
                    </li>
                  </ul>
                </div>
