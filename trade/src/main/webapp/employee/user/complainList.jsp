								...
								<table class="table table-hover table-borderless border-v">
									...
									<tbody>
										<c:forEach var="list" items="${list}">
											<tr class="accordion-toggle collapsed" id="c-${list.user_id}"
												data-toggle="collapse" data-parent="#c-${list.user_id}"
												href="#collap-${list.user_id}">
												<td>${list.user_id}</td>
												...
												<td><button
													...
													<div class="dropdown-menu dropdown-menu-right">
														<a class="dropdown-item"
															href="./UserSuspendActiveForm.emp?user_id=${list.user_id}">회원
															정지</a> <a class="dropdown-item"
															href="./UserInfo.emp?user_id=${list.user_id}">회원 상세
															정보</a>
													</div></td>
											</tr>
											<c:forEach var="com" items="${list.reportList}">
												<tr id="collap-${list.user_id}"
