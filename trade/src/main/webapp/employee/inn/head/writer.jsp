...
<link rel="stylesheet"
	href="./employee/template/css/jquery.timepicker.css">
<link rel="stylesheet" href="./employee/template/css/quill.snow.css">
<!-- Date Range Picker CSS -->
<link rel="stylesheet"
	href="./employee/template/css/daterangepicker.css">
<!-- App CSS -->
<link rel="stylesheet" href="./employee/template/css/app-light.css"
	id="lightTheme">
<link rel="stylesheet" href="./employee/template/css/app-dark.css"
