  ...
  <c:if test="${sessionScope.emp_id == null or sessionScope.emp_id != admin}">
    ...
    <div class="wrapper vh-100">
      <div class="row align-items-center h-100">
        <form action="./DeleteAction.emp" method="post" class="col-lg-3 col-md-4 col-10 mx-auto text-center">
        <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="./Main.emp">
          ...
          <h1 class="h1 mb-3">회원 삭제</h1>
          <input type="hidden" name="del_id" value="${requestScope.del_id}">  
