...
<!-- 비밀번호 찾기(로그인 할 때), 사번 및 이메일 입력 후  -->
    ...
    <div class="wrapper vh-100">
      <div class="row align-items-center h-100">
        <form action="./ResetPwAction.emp" method="post" class="col-lg-3 col-md-4 col-10 mx-auto text-center">
          <div class="mx-auto text-center my-4">
            <h2 class="my-3">비밀번호 초기화</h2>
          </div>
          <div class="form-group">
            <label for="inputId" class="sr-only">사번</label>
            <input type="text" name="emp_id" id="inputId" class="form-control form-control-lg" placeholder="사번" required autofocus>
          </div>
          <div class="form-group">
