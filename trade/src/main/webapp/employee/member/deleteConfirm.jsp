    ...
    <div class="wrapper vh-100">
      <div class="row align-items-center h-100">
        <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="./Main.emp">
          ...
          <h1 class="h1 mb-3">삭제 확인</h1>
          <div class="alert alert-success" role="alert"><strong>${requsetScope.emp_id}</strong>의 삭제가 완료되었습니다.<br>메인 페이지로 이동합니다. </div>
