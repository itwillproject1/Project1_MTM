		...
		<div class="row align-items-center h-100">
			<form action="./EmployeeRegisterAction.emp" method="post"
				...
				<div class="form-group">
					<label for="inputaddr">주소</label> <input type="text" name="address"
						class="form-control" id="inputaddr">
				</div>
				<div class="form-group">
					<label for="inputEmail">이메일</label> <input type="text" name="email"
						class="form-control" id="inputEmail">
				</div>
				<hr class="my-4">
				<div class="form-row">
					<div class="form-group col-md-6">
						<label for="emp_id">사번</label> <input type="text" name="emp_id"
