! function(t) {
    ...
    k.prototype = {
        ...
        _process_options: function(t) {
            ...
            var s, n, o, r = String(e.orientation).toLowerCase().split(/\s+/g),
            ...
            if (e.orientation = {
                ...
                if (1 === r.length) switch (r[0]) {
                    ...
                    case "right":
                        e.orientation.x = r[0]
                } else h = x.grep(r, function(t) {
                    return /^left|right$/.test(t)
                }), e.orientation.x = h[0] || "auto", h = x.grep(r, function(t) {
                    return /^top|bottom$/.test(t)
                }), e.orientation.y = h[0] || "auto";
            e.defaultViewDate instanceof Date || "string" == typeof e.defaultViewDate ? e.defaultViewDate = N.parseDate(e.defaultViewDate, a, e.language, e.assumeNearbyYear) : e.defaultViewDate ? (s = e.defaultViewDate.year || (new Date).getFullYear(), n = e.defaultViewDate.month || 0, o = e.defaultViewDate.day || 1, e.defaultViewDate = S(s, n, o)) : e.defaultViewDate = F()
        },
        ...
        place: function() {
            ...
            return "auto" === f && (f = -s + u - e < 0 ? "bottom" : "top"), this.picker.addClass("datepicker-orient-" + f), "top" === f ? u -= e + parseInt(this.picker.css("padding-top")) : u += l, this.o.rtl ? (p = a - (c + d), this.picker.css({
                top: u,
                right: p,
                zIndex: r
            })) : this.picker.css({
        ...
        fill: function() {
            ...
            if (!isNaN(s) && !isNaN(a)) {
                ...
                for (var m, y, v, w, k, b, _ = []; f.valueOf() < D;) {
                    (m = f.getUTCDay()) === this.o.weekStart && (_.push("<tr>"), this.o.calendarWeeks) && (v = new Date(+f + (this.o.weekStart - m - 7) % 7 * 864e5), w = new Date(Number(v) + (11 - v.getUTCDay()) % 7 * 864e5), k = new Date(Number(k = S(w.getUTCFullYear(), 0, 1)) + (11 - k.getUTCDay()) % 7 * 864e5), b = (w - k) / 864e5 / 7 + 1, _.push('<td class="cw">' + b + "</td>")), (y = this.getClassNames(f)).push("day");
                    var C = f.getUTCDate();
                    this.o.beforeShowDay !== x.noop && ((e = this.o.beforeShowDay(this._utc_to_local(f))) === V ? e = {} : "boolean" == typeof e ? e = {
                        enabled: e
                    } : "string" == typeof e && (e = {
                        classes: e
                    }), !1 === e.enabled && y.push("disabled"), e.classes && (y = y.concat(e.classes.split(/\s+/))), e.tooltip && (t = e.tooltip), e.content && (C = e.content)), y = x.isFunction(x.uniqueSort) ? x.uniqueSort(y) : x.unique(y), _.push('<td class="' + y.join(" ") + '"' + (t ? ' title="' + t + '"' : "") + ' data-date="' + f.getTime().toString() + '">' + C + "</td>"), t = null, m === this.o.weekEnd && _.push("</tr>"), f.setUTCDate(f.getUTCDate() + 1)
                }
                this.picker.find(".datepicker-days tbody").html(_.join(""));
                var T, M = A[this.o.language].monthsTitle || A.en.monthsTitle || "Months",
                    U = this.picker.find(".datepicker-months").find(".datepicker-switch").text(this.o.maxViewMode < 2 ? M : s).end().find("tbody span").removeClass("active");
                x.each(this.dates, function(t, e) {
                    e.getUTCFullYear() === s && U.eq(e.getUTCMonth()).addClass("active")
                }), (s < n || r < s) && U.addClass("disabled"), s === n && U.slice(0, o).addClass("disabled"), s === r && U.slice(h + 1).addClass("disabled"), this.o.beforeShowMonth !== x.noop && (T = this, x.each(U, function(t, e) {
    ...
    var a = x.fn.datepicker,
        s = function(o) {
            ...
            if (h.shift(), this.each(function() {
                    ...
                    }(x.extend({}, d, t, n).language), i = x.extend({}, d, e, t, n), s = a.hasClass("input-daterange") || i.inputs ? (x.extend(i, {
                        inputs: i.inputs || a.find("input").toArray()
                    }), new l(this, i)) : new k(this, i), a.data("datepicker", s)), "string" == typeof o && "function" == typeof s[o] && (r = s[o].apply(s, h))
        ...
        N = {
            ...
            parseDate: function(t, e, i, s) {
                ...
                if (t in d && (t = d[t]), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/i.test(t)) {
                    for (n = t.match(/([\-+]\d+)([dmwy])/gi), t = new Date, v = 0; v < n.length; v++) o = n[v].match(/([\-+]\d+)([dmwy])/i), r = Number(o[1]), h = l[o[2].toLowerCase()], t = k.prototype[h](t, r);
                ...
                var D = e.parts.slice();
                if (n.length !== D.length && (D = x(D).filter(function(t, e) {
                        return -1 !== x.inArray(e, f)
                    }).toArray()), n.length === D.length) {
                    for (var m, y, v = 0, w = D.length; v < w; v++) {
                        if (c = parseInt(n[v], 10), o = D[v], isNaN(c)) switch (o) {
                            case "MM":
                                u = x(A[i].months).filter(a), c = x.inArray(u[0], A[i].months) + 1;
                                break;
                            case "M":
                                u = x(A[i].monthsShort).filter(a), c = x.inArray(u[0], A[i].monthsShort) + 1
                        }
                        p[o] = c
                    }
                    for (v = 0; v < f.length; v++)(y = f[v]) in p && !isNaN(p[y]) && (m = new Date(t), g[y](m, p[y]), isNaN(m) || (t = m))
                }
                return t
            },
