        ...
        return _inherits(C, Emitter), _createClass(C, null, [{
                    ...
                    addedfile: function(t) {
                        ...
                        if (this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer) {
                            ...
                            var h = function(e) {
                                ...
                                v = void 0;
                            try {
                                for (var y, g = t.previewElement.querySelectorAll("[data-dz-remove]")[Symbol.iterator](); !(f = (y = g.next()).done); f = !0) y.value.addEventListener("click", h)
                            } catch (e) {
                                m = !0, v = e
                            } finally {
                                try {
            ...
            value: function(e) {
                if (e.status === C.UPLOADING) {
                    var t = this._getFilesWithXhr(e.xhr),
                        ...
                        r = void 0;
                    try {
                        for (var o, a = t[Symbol.iterator](); !(n = (o = a.next()).done); n = !0) o.value.status = C.CANCELED
                    } catch (e) {
                        i = !0, r = e
                    } finally {
                        try {
            ...
            value: function(s) {
                ...
                this._transformFiles(s, function(e) {
                    ...
                    if (u.options.chunking && (t = e[0], s[0].upload.chunked = u.options.chunking && (u.options.forceChunking || t.size > u.options.chunkSize), s[0].upload.totalChunkCount = Math.ceil(t.size / u.options.chunkSize)), s[0].upload.chunked) {
                        ...
                        r.upload.chunks = [];
                        var i = function() {
                            for (var e, t, n, i = 0; void 0 !== r.upload.chunks[i];) i++;
            ...
            value: function(t, e) {
                var n = this,
                    ...
                    a = void 0;
                try {
                    for (var l, s = t[Symbol.iterator](); !(r = (l = s.next()).done); r = !0) l.value.xhr = i
                } catch (e) {
                    o = !0, a = e
                } finally {
                    try {
