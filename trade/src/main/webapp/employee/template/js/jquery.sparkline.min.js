! function(S, z, N) {
    ...
    t = function(L) {
        "use strict";
        var m, A, C, F, B, O, g, b, t, n, p, V, u, e, i, q, X, h, a, o, l, w, s, r, c, d, f, v = {},
            x = 0,
            y = function() {
                return {
                    common: {
        ...
        L.SPFormatClass = m = R({
            ...
            for (var i = [], s = 0, r = t.length; s < r; s++) t[s] !== e && i.push(t[s]);
            return i
        }, g = function(t) {
            ...
            mouseenter: function(t) {
                L(S.body).unbind("mousemove.jqs"), L(S.body).bind("mousemove.jqs", L.proxy(this.mousemove, this)), this.over = !0, this.currentPageX = t.pageX, this.currentPageY = t.pageY, this.currentEl = t.target, !this.tooltip && this.displayTooltips && (this.tooltip = new e(this.options), this.tooltip.updatePosition(t.pageX, t.pageY)), this.updateDisplay()
            },
            mouseleave: function() {
        ...
        }), f = [], L.fn.sparkline = function(l, i) {
            return this.each(function() {
                var t, h = new L.fn.sparkline.options(this, i),
                    o = L(this),
                    e = function() {
                        var t, e, i, s, r, n = "html" === l || l === N ? ((r = this.getAttribute(h.get("tagValuesAttribute"))) !== N && null !== r || (r = o.html()), r.replace(/(^\s*<!--)|(-->\s*$)|\s+/g, "").split(",")) : l,
                            a = "auto" === h.get("width") ? n.length * h.get("defaultPixelsPerValue") : h.get("width");
                        "auto" === h.get("height") ? h.get("composite") && L.data(this, "_jqs_vcanvas") || ((e = S.createElement("span")).innerHTML = "a", o.html(e), t = L(e).innerHeight() || L(e).height(), L(e).remove(), e = null) : t = h.get("height"), h.get("disableInteraction") ? i = !1 : (i = L.data(this, "_jqs_mhandler")) ? h.get("composite") || i.reset() : (i = new u(this, h), L.data(this, "_jqs_mhandler", i)), !h.get("composite") || L.data(this, "_jqs_vcanvas") ? ((s = new(L.fn.sparkline[h.get("type")])(this, n, h, a, t)).render(), i && i.registerSparkline(s)) : L.data(this, "_jqs_errnotify") || (alert("Attempted to attach a composite sparkline to an element with no existing sparkline"), L.data(this, "_jqs_errnotify", !0))
                    };
                if (L(this).html() && !h.get("disableHiddenCheck") && L(this).is(":hidden") || !L(this).parents("body").length) {
                    if (!h.get("composite") && L.data(this, "_jqs_pending"))
                        for (t = f.length; t; t--) f[t - 1][0] == this && f.splice(t - 1, 1);
                    f.push([this, e]), L.data(this, "_jqs_pending", !0)
                } else e.call(this)
            })
        }, L.fn.sparkline.defaults = y(), L.sparkline_display_visible = function() {
            for (var t, e = [], i = 0, s = f.length; i < s; i++) t = f[i][0], L(t).is(":visible") && !L(t).parents().is(":hidden") ? (f[i][1].call(t), L.data(f[i][0], "_jqs_pending", !1), e.push(i)) : L(t).closest("html").length || L.data(t, "_jqs_pending") || (L.data(f[i][0], "_jqs_pending", !1), e.push(i));
            for (i = e.length; i; i--) f.splice(e[i - 1], 1)
        }, L.fn.sparkline.options = R({
            init: function(t, e) {
                var i, s, r, n;
                this.userOptions = e = e || {}, this.tag = t, this.tagValCache = {}, r = (s = L.fn.sparkline.defaults).common, this.tagOptionsPrefix = e.enableTagOptions && (e.tagOptionsPrefix || r.tagOptionsPrefix), i = (n = this.getTagSetting("type")) === v ? s[e.type || r.type] : s[n], this.mergedOptions = L.extend({}, r, i, e)
            },
            ...
            scanValues: function() {
                for (var t, e, i, s, r = this.values, n = r.length, a = this.xvalues, h = this.yvalues, o = this.yminmax, l = 0; l < n; l++) t = r[l], e = "string" == typeof r[l], i = "object" == typeof r[l] && r[l] instanceof Array, s = e && r[l].split(":"), e && 2 === s.length ? (a.push(Number(s[0])), h.push(Number(s[1])), o.push(Number(s[1]))) : i ? (a.push(t[0]), h.push(t[1]), o.push(t[1])) : (a.push(l), null === r[l] || "null" === r[l] ? h.push(null) : (h.push(Number(t)), o.push(Number(t))));
                this.options.get("xvalues") && (a = this.options.get("xvalues")), this.maxy = this.maxyorg = z.max.apply(z, o), this.miny = this.minyorg = z.min.apply(z, o), this.maxx = z.max.apply(z, a), this.minx = z.min.apply(z, a), this.xvalues = a, this.yvalues = h, this.yminmax = o
            },
            ...
            type: "bar",
            init: function(t, e, i, s, r) {
                var n, a, h, o, l, g, p, u, c, d, f, v, m, x, y, C, w, b, R, S = parseInt(i.get("barWidth"), 10),
                    ...
                    W = 1 / 0,
                    T = -1 / 0;
                for (X._super.init.call(this, t, e, i, s, r), j = 0, P = e.length; j < P; j++)((n = "string" == typeof(b = e[j]) && -1 < b.indexOf(":")) || L.isArray(b)) && (m = !0, n && (b = e[j] = B(b.split(":"))), b = O(b, null), (a = z.min.apply(z, b)) < W && (W = a), T < (h = z.max.apply(z, b)) && (T = h));
                this.stacked = m, this.regionShapes = {}, this.barWidth = S, this.barSpacing = k, this.totalBarWidth = S + k, this.width = s = e.length * S + (e.length - 1) * k, this.initTarget(), H && (f = M === N ? -1 / 0 : M, v = _ === N ? 1 / 0 : _), l = [], o = m ? [] : l;
                for (var q = [], I = [], j = 0, P = e.length; j < P; j++)
                    if (m)
                        for (x = e[j], e[j] = w = [], q[j] = 0, y = o[j] = I[j] = 0, C = x.length; y < C; y++) null !== (b = w[y] = H ? A(x[y], f, v) : x[y]) && (0 < b && (q[j] += b), W < 0 && 0 < T ? b < 0 ? I[j] += z.abs(b) : o[j] += b : o[j] += z.abs(b - (b < 0 ? T : W)), l.push(b));
                    else b = H ? A(e[j], f, v) : e[j], null !== (b = e[j] = F(b)) && l.push(b);
                this.max = d = z.max.apply(z, l), this.min = c = z.min.apply(z, l), this.stackMax = T = m ? z.max.apply(z, q) : d, this.stackMin = W = m ? z.min.apply(z, l) : c, i.get("chartRangeMin") !== N && (i.get("chartRangeClip") || i.get("chartRangeMin") < c) && (c = i.get("chartRangeMin")), i.get("chartRangeMax") !== N && (i.get("chartRangeClip") || i.get("chartRangeMax") > d) && (d = i.get("chartRangeMax")), this.zeroAxis = p = i.get("zeroAxis", !0), u = c <= 0 && 0 <= d && p ? 0 : 0 == p || 0 < c ? c : d, this.xaxisOffset = u, g = m ? z.max.apply(z, o) + z.max.apply(z, I) : d - c, this.canvasHeightEf = p && c < 0 ? this.canvasHeight - 2 : this.canvasHeight - 1, c < u ? (R = ((m && 0 <= d ? T : d) - u) / g * this.canvasHeight) !== z.ceil(R) && (this.canvasHeightEf -= 2, R = z.ceil(R)) : R = this.canvasHeight, this.yoffset = R, L.isArray(i.get("colorMap")) ? (this.colorMapByIndex = i.get("colorMap"), this.colorMapByValue = null) : (this.colorMapByIndex = null, this.colorMapByValue = i.get("colorMap"), this.colorMapByValue && this.colorMapByValue.get === N && (this.colorMapByValue = new V(this.colorMapByValue))), this.range = g
            },
            getRegion: function(t, e, i) {
            ...
            getCurrentRegionFields: function() {
                for (var t, e = this.currentRegion, i = n(this.values[e]), s = [], r = i.length; r--;) t = i[r], s.push({
                    isNull: null === t,
                    value: t,
            ...
            renderRegion: function(t, e) {
                var i, s, r, n, a, h, o = this.values[t],
                    l = this.options,
                    g = this.xaxisOffset,
                    p = [],
                    u = this.range,
                    ...
                    C = b(null, o),
                    w = b(g, o, !0);
                if (C) return l.get("nullColor") ? (r = e ? l.get("nullColor") : this.calcHighlightColor(l.get("nullColor"), l), i = 0 < m ? m - 1 : m, d.drawRect(f, i, this.barWidth - 1, 0, r, r)) : N;
                for (n = m, a = 0; a < x; a++) {
                    if (y = o[a], c && y === g) {
                        if (!w || h) continue;
                        h = !0
                    }
                    s = 0 < u ? z.floor(v * (z.abs(y - g) / u)) + 1 : 1, y < g || y === g && 0 === m ? (i = n, n += s) : (i = m - s, m -= s), r = this.calcColor(a, y, t), e && (r = this.calcHighlightColor(r, l)), p.push(d.drawRect(f, i, this.barWidth - 1, s - 1, r, r))
                }
            ...
            renderRegion: function(t, e) {
                ...
                if (null !== g) return e && (g = this.calcHighlightColor(g, r)), n.drawRect(o, i, this.barWidth - 1, l - 1, g, g)
            }
            ...
            renderSlice: function(t, e) {
                for (var i, s, r, n = this.target, a = this.options, h = this.radius, o = a.get("borderWidth"), l = a.get("offset"), g = 2 * z.PI, p = this.values, u = this.total, c = l ? 2 * z.PI * (l / 360) : 0, d = p.length, f = 0; f < d; f++) {
                    if (s = i = c, 0 < u && (s = c + g * (p[f] / u)), t === f) return r = a.get("sliceColors")[f % a.get("sliceColors").length], e && (r = this.calcHighlightColor(r, a)), n.drawPieSlice(h, h, h - o, i, s, N, r);
                    c = s
                }
            },
            render: function() {
            ...
            _calculatePixelDims: function(t, e, i) {
                ...
                this.pixelHeight = s ? s[1] : L(i).height(), s = this._pxregex.exec(t), this.pixelWidth = s ? s[1] : L(i).width()
            },
            ...
            init: function(t, e, i, s) {
                c._super.init.call(this, t, e, i), this.canvas = S.createElement("canvas"), i[0] && (i = i[0]), L.data(i, "_jqs_vcanvas", this), L(this.canvas).css({
            ...
            replaceWithShapes: function(t, e) {
                for (var i, s, r = this.shapeseq, n = {}, a = t.length; a--;) n[t[a]] = !0;
                for (a = r.length; a--;) n[i = r[a]] && (r.splice(a, 1), delete this.shapes[i], s = a);
                for (a = e.length; a--;) r.splice(s, 0, e[a].id), this.shapes[e[a].id] = e[a]
            },
            insertAfterShape: function(t, e) {
                for (var i = this.shapeseq, s = i.length; s--;)
                    if (i[s] === t) return i.splice(s + 1, 0, e.id), void(this.shapes[e.id] = e)
            },
            removeShapeId: function(t) {
            ...
            init: function(t, e, i) {
                var s;
                d._super.init.call(this, t, e, i), i[0] && (i = i[0]), L.data(i, "_jqs_vcanvas", this), this.canvas = S.createElement("span"), L(this.canvas).css({
                    display: "inline-block",
                    position: "relative",
                    overflow: "hidden",
                    width: t,
            ...
            _drawShape: function(t, e, i, s, r) {
                for (var n, a, h, o, l = [], g = 0, p = e.length; g < p; g++) l[g] = e[g][0] + "," + e[g][1];
            ...
            replaceWithShapes: function(t, e) {
                for (var i = L("#jqsshape" + t[0]), s = "", r = e.length, n = 0; n < r; n++) s += this["_draw" + e[n].type].apply(this, e[n].args);
                for (i[0].outerHTML = s, n = 1; n < t.length; n++) L("#jqsshape" + t[n]).remove()
            },
            insertAfterShape: function(t, e) {
                var i = L("#jqsshape" + t),
                    s = this["_draw" + e.type].apply(this, e.args);
