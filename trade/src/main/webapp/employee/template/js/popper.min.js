! function(e, t) {
    ...
    function c(e, t, n, o, r) {
        var i, s, f, a, p, l = 4 < arguments.length && void 0 !== r && r,
            u = {
                top: 0,
                left: 0
            },
    ...
    function d(n, o) {
        Object.keys(o).forEach(function(e) {
            var t = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(e) && p(o[e]) && (t = "px"), n.style[e] = o[e] + t
        })
    }
    ...
    return te.Utils = ("undefined" == typeof window ? global : window).PopperUtils, te.placements = K, te.Defaults = {
        ...
        modifiers: {
            shift: {
                ...
                enabled: !0,
                fn: function(e) {
                    var t, n, o, r, i, s, f, a = e.placement,
                        p = a.split("-")[0],
                        l = a.split("-")[1];
